...
function loadData() {
    ...
    // console.log(`${LINKROOT}/Distributor/searchRequestedManufacturers?searchTerm=${encodeURIComponent(searchTerm)}`);
    fetch(`${LINKROOT}/DistributorNoMan/searchRequestedManufacturers?searchTerm=${encodeURIComponent(searchTerm)}`, {
        method: 'GET',
        headers: {
