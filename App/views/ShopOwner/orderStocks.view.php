            ...
            <div class="row col-max-1024">
                ...
                <div class="colomn fg1">
                    ...
                    <div class="row scan">
                        ...
                        <div>
                            <label for="bulk-price">Bulk Price</label>
                            <input class="userInput short" type="text" id="bulk-price" readonly tabindex="-1">
                        </div>
                        <div>
...
<script>
    ...
    const disPhone = "<?=$dis_phone?>";
    const ws_id = "<?=$_SESSION['shop_owner']['phone']?>";
</script>
<script src="<?=ROOT?>/js/ShopOwner/orderStocks.js" type="module"></script>
