...
<div class="main-content colomn">
    ...
    <div class="row">
      ...
      <a href ="<?=LINKROOT?>/DistributorNoMan/requestedManufacturers" class ="btn">Requested Manufacturer</a>
    </div>
    ...
    <div class="popUpDiv hidden" id="manPopUp">
        <div>
            ...
            <tr>
                <td colspan = "2">
                    <div class="row">
                        <form method ="post" id ="sendRquestBtn" action="<?=LINKROOT?>/DistributorNoMan/sendDisRequest">
                            <input type="hidden" id="man_phonehidden" name="man_phonehidden">
                            <button type="submit" class = "btn fg1" >Send Request</button>
                        </form>
                    </div>
                </td>
            </tr>
    ...
    <script src="<?=ROOT?>/js/Distributor/viewManufacturers.js"></script>
